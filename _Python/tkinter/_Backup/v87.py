    ...
    if macro_name == "Save_Optimal_Model":
        ...
        try:
            ...
            with open(path, "w", encoding="utf-8") as fp:
                fp.write("REMFluor-MD Optimal Model snapshot v3\n")
...
class REMFluorApp(tk.Tk):
    ...
    def _build_vars(self):
        ...
        # Section 11
        # v87: was "100" — but with form defaults of yr_start=1977
        # / yr_end=2077 (100-yr sim) and dt=0.1, see_every=100 forces
        # npt=1000 and output only at t=100 (one dropdown year).
        # Default 10 gives output every 10 yr → 11 dropdown options.
        self.v_see_every = tk.StringVar(value="10")
