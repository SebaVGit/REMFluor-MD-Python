...
class REMFluorApp(tk.Tk):
    ...
    def _toggle_widgets(self, widgets, show):
        ...
        Supports both grid- and pack-managed widgets.  Pack info is
        cached on the widget the first time it's hidden so it can be
        restored later.
        """
        for w in widgets:
            try:
            ...
            try:
                if mgr == "grid":
                    ...
                    if show:
                        ...
                        w.pack_forget()
                # else: widget never gridded/packed — nothing to do.
            except Exception:
                pass
    ...
    def _build_s10_field_data(self, parent):
        ...
        detailed_block.pack(side="left", anchor="n", padx=(40, 0))
        make_btn(detailed_block, "Enter Monitoring\nWell Data",
                 "EnterMonitoringWellData",
                 font=FONT_BTN, width=22, bg=BTN_FILL,
                 padx=20, pady=14
