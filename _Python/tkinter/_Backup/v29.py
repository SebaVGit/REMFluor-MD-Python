...
class REMFluorApp(tk.Tk):
    ...
    def _build_s10_field_data(self, parent):
        ...
        # Red value text on white bg — matches Excel field-data column
        ...
        # Right-side descriptive notes — RED italic per Excel storyboard
        # (was FG_GREY).  Distances stay red text / white bg.
        for i in range(7):
