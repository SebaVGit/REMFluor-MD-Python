...
class REMFluorApp(tk.Tk):
    ...
    def _build_top_bar(self, parent):
        ...
        # Title in the same greenish tint as the Excel storyboard:
        # "REMFluor", "-MD Model Input Screen", and "Vers. 2.6" all use
        # FG_TITLE_GREEN (#DAF2D0).  Previously only "REMFluor" was tinted;
        # the rest was plain white.
        ...
        tk.Label(bar, text="Vers. 2.6",
                 font=FONT_VERSION, fg=FG_TITLE_GREEN, bg=BG_HEADER_BAR
