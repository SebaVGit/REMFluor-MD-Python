...
class REMFluorApp(tk.Tk):
    ...
    def _build_s11_output(self, parent):
        ...
        # Two big Run Model buttons
        make_btn(bar, "Run Model", "RunPythonScript",
                 fg=FG_BTN_NAVY, font=FONT_BTN_LG, padx=12, pady=10,
                 bg=BTN_FILL_BLUE, width=14).pack(side="left", padx=6)
        make_btn(bar, "Run Model with\nAuto-Calibration",
                 "Show_Visualization",
                 fg=FG_BTN_NAVY, font=FONT_BTN_LG, padx=12, pady=10,
                 bg=BTN_FILL_BLUE, width=18).pack(side="left", padx=6)

        # 3x2 action grid on the right (5 buttons; bottom-right empty)
        actfr = tk.Frame(bar, bg=BTN_FILL_BLUE)
        actfr.pack(side="left", padx=(12, 0))
        cells = [
            ...
            (1, 0, "Clear All Data", "Clear_Data",    BTN_FILL,       FG_BTN_NAVY),
            (1, 1, "Paste Example",  "Paste_Example", BTN_FILL,       FG_BTN_NAVY),
        ]
        for r, c, txt, macro, bg, fg in cells:
            make_btn(actfr, txt, macro,
                     fg=fg, font=FONT_BTN, padx=10, pady=4,
                     bg=bg, width=13
