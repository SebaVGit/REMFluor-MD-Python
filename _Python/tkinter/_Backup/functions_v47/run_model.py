...
def run(app, parent=None) -> bool:
    ...
    # Smaller font + wider window so multi-line status messages
    # ("Dashboard Launched / check your browser — http://localhost:8050")
    # fit comfortably without wrapping mid-word.
    ...
    # Wide + roomy so all status messages fit on 2-3 lines max
