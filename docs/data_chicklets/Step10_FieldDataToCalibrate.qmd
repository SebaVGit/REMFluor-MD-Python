...
| ----------------- | ------------------------------------------------------------------------- |
| Description       | The year sampled. You may only plug in one sample event for simple version |
| Units             | YEAR                                                                   |
...
| **PARAMETER**     | **MONITORING WELL NAME**                                                                    |
| ----------------- | ------------------------------------------------------------------------------------------- |
| Description       | Name of the monitoring well used in sampling. Must match the well name in the location tab. |
| Units             | Text                                                                                        |
| Typical Values    | Example: MW-01                                                                              |
| Source of Data    | Monitoring well records                                                                     |
| How to Enter Data | Enter well name matching the location tab                                                   |
...
| **PARAMETER**     | **DISTANCE FROM SOURCE**                                                  |
| ----------------- | ------------------------------------------------------------------------- |
| Description       | Horizontal distance from the contamination source to the monitoring well. |
| Units             | m or ft                                                                   |
| Typical Values    | Example: 150                                                              |
| Source of Data    | Field survey / site map                                                   |
| How to Enter Data | Enter horizontal distance from source                                     |
...
| Units             | µg/L                                    |
| Typical Values    | Example: µg/L                           |
| Source of Data    | Lab analysis                            |
| How to Enter Data | Enter units                             |

</div>

**Note:** This version requires loading the Excel template (CalibrationTemplate.xlsx) that includes all model location and model data information. Use the template formatting as a guide, or create your own Excel file following the same structure. This allows for spatially resolved calibration using multiple wells and data points for refined model calibration.
